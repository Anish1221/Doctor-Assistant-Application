...
public class HomeScreenDoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userIdImportedString = detailsImported.getString("DOCTOR_USER_ID");
        ...
        welcomeDoc = (TextView) findViewById(R.id.welcome_doc);
        welcomeDoc.setText("Welcome, "+"Doctor");
    }
    ...
    public class BackgroundTask extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute(){
            checkIfAdmNoExistURL = "http://anoyin.000webhostapp.com/checkIfAdmNoExist.php";
        }
